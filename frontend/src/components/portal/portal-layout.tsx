...
import { MessageSquare, FileText, TrendingUp, Users, Shield, Power, Bot, Zap } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/portal/quick-replies', label: 'Respuestas', icon: Zap, permission: 'ai_config:manage' },
];
